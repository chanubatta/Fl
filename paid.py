...
time.sleep(2)
os.system(f'xdg-open https//t.me/Termux_2002')
os.system(f'xdg-open Https//t.me/Termux_2002')
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+94705184875?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  ChanukaFbhack,  V I P,  Tools"')
def back():
	login()
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/chanuka.ravindu2001")
    if hc in ['1','01']:
